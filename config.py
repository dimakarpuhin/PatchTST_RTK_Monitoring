...
class Config:
    ...
    # ========== Параметры для синтетических данных ==========Эксперимент 1 - увеличивал количество образцов на класс с 50 до 2000, на 2000 точность получилась 99% что означает переобучение
