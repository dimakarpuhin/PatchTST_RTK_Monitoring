...
class Config:
    ...
    EARLY_STOPPING_PATIENCE = 20  # Остановка при отсутствии улучшений
    ...
    DRIFT_RATE = 0.0005          # скорость дрейфа (0.0005 — медленный дрейф)
    DROPOUT_PROB = 0.01          # вероятность пропуска данных (1%)
    IMPULSE_PROB = 0.02         # вероятность импульсной помехи (2%)
    IMPULSE_AMPLITUDE = 5.0      # амплитуда импульсной помехи (в стандартных отклонениях)
